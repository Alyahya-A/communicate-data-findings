...
<br>
I delete all user more than 60 years old because most users are between 18-58 year old (See findings exploration file for more details). Also I created new columns like age_category, duration_min, distance_km, start_time month, monthly, day, and hour. After I cleaned my data and craeted new columns the data became 3,177,270 records and 25 columns.
<br>
<br>
